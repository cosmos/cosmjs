 ...
 */
export class Comet1Client {
  /**
   * Creates a new Tendermint client for the given endpoint.
   *
   * Uses HTTP when the URL schema is http or https. Uses WebSockets otherwise.
   */
  public static async connect(endpoint: string | HttpEndpoint): Promise<Comet1Client> {
   ...
   */
  public static create(rpcClient: RpcClient): Comet1Client {
