...
describe("Secp256k1", () => {
  ...
  it("encodes public key uncompressed when making a keypair", () => {
  ...
  it("preserves private key when making a keypair", () => {
  ...
  it("can load private keys", () => {
    expect(
      Secp256k1.makeKeypair(fromHex("5eaf4344dab73d0caee1fd03607bb969074fb217f076896c2125f8607feab7b1")),
    ).toBeTruthy();
    expect(
      Secp256k1.makeKeypair(fromHex("f7ac570ea2844e29e7f3b3c6a724ee1f47d3de8c2175a69abae94ae871573d0e")),
    ).toBeTruthy();
    expect(
      Secp256k1.makeKeypair(fromHex("e4ade2a5232a7c6f37e7b854a774e25e6047ee7c6d63e8304ae04fa190bc1732")),
    ).toBeTruthy();
    ...
    expect(
      Secp256k1.makeKeypair(fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364140")),
    ).toBeTruthy();

    // too short and too long
    expect(() =>
      Secp256k1.makeKeypair(fromHex("e4ade2a5232a7c6f37e7b854a774e25e6047ee7c6d63e8304ae04fa190bc17")),
    ).toThrowError("input data is not a valid secp256k1 private key");
    expect(() =>
  ...
  it("creates signatures deterministically", () => {
    const privkey = fromHex("43a9c17ccbb0e767ea29ce1f10813afde5f1e0a7a504e89b4d2cc2b952b8e0b9");
    const keypair = Secp256k1.makeKeypair(privkey);
    const messageHash = new Uint8Array([0x11, 0x22]);
  ...
  it("throws for empty message hash in signing", () => {
    const privkey = fromHex("43a9c17ccbb0e767ea29ce1f10813afde5f1e0a7a504e89b4d2cc2b952b8e0b9");
    const keypair = Secp256k1.makeKeypair(privkey);
    const messageHash = new Uint8Array([]);
    expect(() => Secp256k1.createSignature(messageHash, keypair.privkey)).toThrowError(
      /message hash must not be empty/i,
    );
  });

  it("throws for message hash longer than 32 bytes in signing", () => {
    const privkey = fromHex("43a9c17ccbb0e767ea29ce1f10813afde5f1e0a7a504e89b4d2cc2b952b8e0b9");
    const keypair = Secp256k1.makeKeypair(privkey);
  ...
  it("throws for empty message hash in verification", () => {
  ...
  it("throws for message hash longer than 32 bytes in verification", () => {
    const dummySignature = Secp256k1Signature.fromDer(
      fromHex(
        "304602210083de9be443bcf480892b8c8ca1d5ee65c79a315642c3f7b5305aff3065fda2780221009747932122b93cec42cad8ee4630a8f6cbe127578b8c495b4ab927275f657658",
      ),
  ...
  it("verifies unnormalized pyca/cryptography signatures", () => {
  ...
  it("matches normalized pyca/cryptography signatures", () => {
